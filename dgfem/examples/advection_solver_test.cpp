...
int main() {
    try {
        ...
        std::cout << "  Mass change: " << std::abs(solutions.back().sum() - solutions[0].sum()) / 
                     std::abs(solutions[0].sum()) * 100 << "%" << std::endl;
