...
public:
     ...
     */
    static void write_multi_variable_solution(
        std::shared_ptr<DGMesh> mesh,
     ...
     */
    static void write_euler_solution(
        std::shared_ptr<DGMesh> mesh,
     ...
     * @param resolution_factor Subdivision factor for visualization
     */
    static void write_with_analytical(
        std::shared_ptr<DGMesh> mesh,
        const Eigen::VectorXd& solution,
...
private:
     ...
     */
    static void generate_visualization_mesh(
        std::shared_ptr<DGMesh> mesh,
     ...
     */
    [[nodiscard]] static Eigen::VectorXd evaluate_at_points(
        std::shared_ptr<DGMesh> mesh,
        const Eigen::VectorXd& solution,
     ...
     */
    [[nodiscard]] static Eigen::MatrixXd get_reference_subdivision_points(
     ...
     */
    [[nodiscard]] static Eigen::MatrixXi get_reference_subdivision_connectivity(
        std::string_view element_type,
        int resolution_factor
    );
     ...
     */
    static void write_vtk_header(
        std::ofstream& file,
        const std::string& title = "DGFEM Solution"
    );
    
    /**
     * @brief Write VTK points section
     */
    static void write_vtk_points(
        std::ofstream& file,
     ...
     */
    static void write_vtk_point_data(
        std::ofstream& file,
