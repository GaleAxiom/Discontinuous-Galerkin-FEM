...
public:
    ...
    volume_residual(const Eigen::MatrixXd& u_coeffs_elem,
     ...
     */
    [[nodiscard]] virtual std::tuple<Eigen::MatrixXd, Eigen::MatrixXd>
    interior_face_residual(const Eigen::MatrixXd& u_coeffs_L, const Eigen::MatrixXd& u_coeffs_R,
     ...
     */
    [[nodiscard]] virtual std::tuple<Eigen::Vector4d, Eigen::Vector4d>
    get_fluxes(const Eigen::Vector4d& U) const;

    /**
     * @brief Compute Rusanov numerical flux
     */
    [[nodiscard]] virtual Eigen::Vector4d rusanov_flux(const Eigen::Vector4d& U_L,
    ...
    [[nodiscard]] virtual std::tuple<Eigen::MatrixXd, Eigen::MatrixXd>
    viscous_interior_face_residual(const Eigen::MatrixXd& u_coeffs_L,
...
[[nodiscard]] Eigen::Vector4d primitive_to_conserved(const Eigen::Vector4d& primitive,
                                                     double gamma = 1.4);
[[nodiscard]] Eigen::Vector4d conserved_to_primitive(const Eigen::Vector4d& conserved,
                                                     double gamma = 1.4);
