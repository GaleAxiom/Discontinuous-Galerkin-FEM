...
public:
     ...
     */
    [[nodiscard]] virtual Eigen::MatrixXd compute_volume_integral(
     ...
     */
    [[nodiscard]] virtual std::tuple<Eigen::MatrixXd, Eigen::MatrixXd, Eigen::MatrixXd, Eigen::MatrixXd>
     ...
     */
    [[nodiscard]] virtual Eigen::MatrixXd compute_boundary_face_integral(
     ...
     */
    [[nodiscard]] virtual Eigen::VectorXd compute_boundary_rhs_integral(
        int elem_id, int face_id,
        std::shared_ptr<DGMesh> mesh,
        std::shared_ptr<BoundaryCondition> bc) const = 0;
     ...
     */
    [[nodiscard]] virtual Eigen::VectorXd compute_source_integral(
        int elem_id,
...
public:
     ...
     */
    [[nodiscard]] Eigen::MatrixXd compute_mass_integral(
        const std::map<std::string, Eigen::MatrixXd>& elem_data,
     ...
     */
    [[nodiscard]] virtual std::tuple<Eigen::MatrixXd, Eigen::VectorXd> compute_boundary_face_integral(
        int elem_id, int face_id,
        std::shared_ptr<DGMesh> mesh,
