...
std::unique_ptr<QuadratureRule> QuadratureFactory::gauss_legendre_1d(int n_points) {
    if (!is_valid_gl_order(n_points)) {
        ...
        oss << "Invalid Gauss-Legendre order: " << n_points 
            << ". Must be between 1 and " << MAX_GL_POINTS;
...
std::unique_ptr<QuadratureRule> QuadratureFactory::gauss_legendre_quad(int n_points_1d) {
    if (!is_valid_gl_order(n_points_1d)) {
        std::ostringstream oss;
        oss << "Invalid Gauss-Legendre order: " << n_points_1d 
            << ". Must be between 1 and " << MAX_GL_POINTS;
        throw std::invalid_argument(oss.str());
    }
...
std::unique_ptr<QuadratureRule> QuadratureFactory::dunavant_triangle(int order) {
    if (!is_valid_dunavant_order(order)) {
        std::ostringstream oss;
        oss << "Invalid Dunavant order: " << order 
            << ". Must be between 0 and " << MAX_DUNAVANT_ORDER;
        throw std::invalid_argument(oss.str());
    }
...
void QuadratureFactory::compute_gauss_legendre(int n, Eigen::VectorXd& points, Eigen::VectorXd& weights) {
    points.resize(n);
    weights.resize(n);
    
    // Use compile-time constants where possible
    constexpr double sqrt_3_inv = 1.0 / 1.732050807568877293527446341505872366942805253810380628055;  // 1/sqrt(3)
    constexpr double sqrt_3_5 = 0.774596669241483377035853079956479922166584341058318165320;      // sqrt(3/5)
    ...
    switch (n) {
        ...
        case 4: {
            constexpr double sqrt_6_5 = 1.095445115010332226913939565601604642850062938142840310385;  // sqrt(6/5)
            ...
            points[0] = -b; points[1] = -a; points[2] = a; points[3] = b;
            weights[0] = w2; weights[1] = w1; weights[2] = w1; weights[3] = w2;
            break;
        }
        ...
        case 5: {
            ...
            points[0] = -a; points[1] = -b; points[2] = 0.0; points[3] = b; points[4] = a;
            weights[0] = w1; weights[1] = w2; weights[2] = w3; weights[3] = w2; weights[4] = w1;
            break;
        }
        ...
        case 6: {
            ...
            points[3] = c; points[4] = b; points[5] = a;
            weights[0] = w1; weights[1] = w2; weights[2] = w3; 
            weights[3] = w3; weights[4] = w2; weights[5] = w1;
            break;
        }
        ...
        case 7: {
            ...
            points[0] = -a; points[1] = -b; points[2] = -c; points[3] = 0.0;
            points[4] = c; points[5] = b; points[6] = a;
            weights[0] = w1; weights[1] = w2; weights[2] = w3; weights[3] = w4;
            weights[4] = w3; weights[5] = w2; weights[6] = w1;
            break;
        }
        ...
        case 8: {
            ...
            points[4] = d; points[5] = c; points[6] = b; points[7] = a;
            weights[0] = w1; weights[1] = w2; weights[2] = w3; weights[3] = w4;
            weights[4] = w4; weights[5] = w3; weights[6] = w2; weights[7] = w1;
            break;
        }
...
void QuadratureFactory::get_dunavant_rule(int order, Eigen::MatrixXd& points, Eigen::VectorXd& weights) {
    ...
    switch (order) {
        ...
        case 2: {
            ...
            points.resize(3, 2);
            weights.resize(3);
            points(0, 0) = 1.0/6.0; points(0, 1) = 1.0/6.0;
            points(1, 0) = 1.0/6.0; points(1, 1) = 2.0/3.0;
            points(2, 0) = 2.0/3.0; points(2, 1) = 1.0/6.0;
        ...
        case 3: {
            ...
            points.resize(4, 2);
            weights.resize(4);
            points(0, 0) = one_third; points(0, 1) = one_third;
            points(1, 0) = 0.2; points(1, 1) = 0.2;
            points(2, 0) = 0.2; points(2, 1) = 0.6;
            points(3, 0) = 0.6; points(3, 1) = 0.2;
        ...
        case 12: {
            ...
            points(0, 0) = 4.88963910362179e-1; points(0, 1) = 4.88963910362179e-1;
            points(1, 0) = 4.88963910362179e-1; points(1, 1) = 2.20721792756430e-2;
            points(2, 0) = 2.20721792756430e-2; points(2, 1) = 4.88963910362179e-1;
            points(3, 0) = 4.17644719340454e-1; points(3, 1) = 4.17644719340454e-1;
            points(4, 0) = 4.17644719340454e-1; points(4, 1) = 1.64710561319092e-1;
            points(5, 0) = 1.64710561319092e-1; points(5, 1) = 4.17644719340454e-1;
            points(6, 0) = 2.73477528308839e-1; points(6, 1) = 2.73477528308839e-1;
            points(7, 0) = 2.73477528308839e-1; points(7, 1) = 4.53044943382323e-1;
            points(8, 0) = 4.53044943382323e-1; points(8, 1) = 2.73477528308839e-1;
            points(9, 0) = 1.77205532412543e-1; points(9, 1) = 1.77205532412543e-1;
            points(10, 0) = 1.77205532412543e-1; points(10, 1) = 6.45588935174913e-1;
            points(11, 0) = 6.45588935174913e-1; points(11, 1) = 1.77205532412543e-1;
            points(12, 0) = 6.17998830908730e-2; points(12, 1) = 6.17998830908730e-2;
            points(13, 0) = 6.17998830908730e-2; points(13, 1) = 8.76400233818255e-1;
            points(14, 0) = 8.76400233818255e-1; points(14, 1) = 6.17998830908730e-2;
            points(15, 0) = 1.93909612487010e-2; points(15, 1) = 1.93909612487010e-2;
            points(16, 0) = 1.93909612487010e-2; points(16, 1) = 9.61218077502598e-1;
            points(17, 0) = 9.61218077502598e-1; points(17, 1) = 1.93909612487010e-2;
            points(18, 0) = 1.72266687821356e-1; points(18, 1) = 7.70608554774996e-1;
            points(19, 0) = 7.70608554774996e-1; points(19, 1) = 5.71247574036480e-2;
            points(20, 0) = 5.71247574036480e-2; points(20, 1) = 1.72266687821356e-1;
            points(21, 0) = 1.72266687821356e-1; points(21, 1) = 5.71247574036480e-2;
            points(22, 0) = 7.70608554774996e-1; points(22, 1) = 1.72266687821356e-1;
            points(23, 0) = 5.71247574036480e-2; points(23, 1) = 7.70608554774996e-1;
            points(24, 0) = 3.36861459796345e-1; points(24, 1) = 5.70222290846683e-1;
            points(25, 0) = 5.70222290846683e-1; points(25, 1) = 9.29162493569720e-2;
            points(26, 0) = 9.29162493569720e-2; points(26, 1) = 3.36861459796345e-1;
            points(27, 0) = 3.36861459796345e-1; points(27, 1) = 9.29162493569720e-2;
            points(28, 0) = 5.70222290846683e-1; points(28, 1) = 3.36861459796345e-1;
            points(29, 0) = 9.29162493569720e-2; points(29, 1) = 5.70222290846683e-1;
            points(30, 0) = 2.98372882136258e-1; points(30, 1) = 6.86980167808088e-1;
            points(31, 0) = 6.86980167808088e-1; points(31, 1) = 1.46469500556540e-2;
            points(32, 0) = 1.46469500556540e-2; points(32, 1) = 2.98372882136258e-1;
            points(33, 0) = 2.98372882136258e-1; points(33, 1) = 1.46469500556540e-2;
            points(34, 0) = 6.86980167808088e-1; points(34, 1) = 2.98372882136258e-1;
            points(35, 0) = 1.46469500556540e-2; points(35, 1) = 6.86980167808088e-1;
            points(36, 0) = 1.18974497696957e-1; points(36, 1) = 8.79757171370171e-1;
            points(37, 0) = 8.79757171370171e-1; points(37, 1) = 1.26833093287199e-3;
            points(38, 0) = 1.26833093287199e-3; points(38, 1) = 1.18974497696957e-1;
            points(39, 0) = 1.18974497696957e-1; points(39, 1) = 1.26833093287199e-3;
            points(40, 0) = 8.79757171370171e-1; points(40, 1) = 1.18974497696957e-1;
            points(41, 0) = 1.26833093287199e-3; points(41, 1) = 8.79757171370171e-1;
